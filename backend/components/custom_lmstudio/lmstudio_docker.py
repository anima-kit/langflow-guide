...
class LMStudioModelwithDockerComponent(LCModelComponent):
    display_name = "LM Studio with Docker"
    description = "Generate text using local LLMs with LM Studio through Docker."
    icon = "LMStudio"
    name = "lmstudio_docker"
    ...
    inputs = [
        *LCModelComponent.get_base_inputs(),
        ...
        StrInput(
            ...
            advanced=False,
            info="Endpoint of the LM Studio API. Defaults to 'http://host.docker.internal:1234/v1' if not specified.",
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        ...
        base_url = self.base_url or "http://host.docker.internal:1234/v1"
        seed = self.seed
